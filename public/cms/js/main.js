...
const scrl = document.querySelector('.sidebar-item.active');
if(scrl)
{
    scrl.scrollIntoView(false)
}

const menuSelector = document.querySelectorAll(".sidebar-item");
menuSelector.forEach(item=>{
    const _self = this;
    const e = item.querySelector("a");
