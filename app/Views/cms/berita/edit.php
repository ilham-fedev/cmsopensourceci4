...
<div class="page-content">
    <section class="row">
            <form action="<?= base_url("panel/berita/". $item->id) ?>" method="post" enctype="multipart/form-data" class="row">
            <?= csrf_field() ?>
            <?= method("PUT") ?>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                          ...
                          <?php if($item->gambar): ?>
                            <div class="m-3">
                              <img src="<?= thumb($item->gambar) ?>" alt="" srcset="">
                            </div>
                          <?php endif ?>
                        ...
                        <div class="mb-3">
                          ...
                          <textarea class="form-control" id="editor" name="isi_berita" rows="3"><?= $item->isi_berita ?></textarea>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                          ...
                          <select name="id_kategori" class="form-select">
                              ...
                              <?php $selected = ($cat->id == $item->id_kategori) ? 'selected' : '' ?>
                        ...
                        <div class="mb-3">
                          ...
                          <select name="tag[]" class="form-select form-select-lg form-tag" multiple>
                              ...
                              <?php $tag_selected = in_array($tag->tag_seo, $tag_select) ? 'selected' : '' ?>
                                <option value="<?= $tag->tag_seo ?>" <?= $tag_selected ?>><?= $tag->nama_tag ?></option>
                              <?php endforeach ?>
                          </select>
                        </div>
                        <div class="mb-3">
