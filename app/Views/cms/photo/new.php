        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="<?= base_url("panel/photo") ?>" method="post" enctype="multipart/form-data">
                            <?= csrf_field() ?>
                            <div class="mb-3">
                              ...
                              <option value="0">-- Pilih Album --</option>
                                <?php foreach($albums as $album): ?>
                                  <option value="<?= $album->id ?>"><?= $album->jdl_album ?></option>
                                <?php endforeach ?>
                              </select>
                            </div>
                            <div class="mb-3">
                              <label class="form-label">Judul</label>
                              <input type="text" class="form-control" name="jdl_galeri" required/>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                              ...
                              <textarea class="form-control" id="editor" name="keterangan" rows="3"></textarea>
                            </div>
                            <div class="mb-3">
