        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="<?= base_url("panel/submenu/" .$item->id) ?>" method="post">
                            <?= csrf_field() ?>
                            <?= method("PUT") ?>
                            <div class="mb-3">
                              ...
                              <select name="id_main" class="form-select">
                                  ...
                                  <?php if($main->id == $item->id_main): ?>
                                  <option value="<?= $main->id ?>" selected><?= $main->nama_menu ?></option>
                                  <?php else: ?>
                            ...
                            <div class="mb-3">
                              ...
                              <input type="text" class="form-control" name="nama_sub" value="<?= $item->nama_sub ?>" required/>
                            </div>
                            <div class="mb-3">
                              <label class="form-label">Link</label>
                              <input type="text" class="form-control" name="link_sub" value="<?= $item->link_sub ?>" required/>
                            </div>
                            <div class="mb-3">
