        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="<?= base_url("panel/halaman/".$item->id) ?>" method="post" enctype="multipart/form-data">
                            <?= csrf_field() ?>
                            <?= method("PUT") ?>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                              ...
                              <?php if($item->gambar): ?>
                                <div class="m-3"><img src="<?= thumb($item->gambar) ?>" alt=""></div>
                              <?php endif ?>
                            ...
                            <div class="mb-3">
                              ...
                              <textarea class="form-control" id="editor" name="isi_halaman" rows="3"><?= $item->isi_halaman ?></textarea>
                            </div>
                            <div class="mb-3">
